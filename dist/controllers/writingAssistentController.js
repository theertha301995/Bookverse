import { getWritingSuggestions, improveSentence, continueStory, } from "../services/writingAssistantService.js";
export const aiWritingSuggestions = async (req, res) => {
    try {
        const { text } = req.body;
        if (!text) {
...
export const aiImproveText = async (req, res) => {
    try {
        const { text } = req.body;
        if (!text) {
            return res.status(400).json({
...
export const aiContinueStory = async (req, res) => {
    try {
        const { text } = req.body;
        if (!text) {
            return res.status(400).json({
...
//# sourceMappingURL=writingAssistentController.js.map